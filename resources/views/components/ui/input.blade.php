...
@php
    ...
    $inputClasses = 'w-full px-4 py-2.5 border rounded-base bg-white text-sand-900 placeholder-sand-400 transition-colors duration-200 focus:outline-none';
...
<div {{ $attributes->only('class')->merge(['class' => 'w-full']) }}>
    ...
    <div class="relative">
        @if($icon)
            <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none text-sand-400">
