        ...
        <form method="POST" action="{{ route('admin.categories.store') }}">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="name" value="{{ old('name') }}" 
                       class="w-full border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-purple-500 focus:border-transparent" 
                       placeholder="Ex: Nature & Aventure" required>
                @error('name')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
                <p class="text-gray-500 text-sm mt-1">Le slug sera généré automatiquement</p>
            </div>
            ...
            <div class="border-t pt-6 mb-6">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="meta_title" value="{{ old('meta_title') }}" 
                           class="w-full border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-purple-500 focus:border-transparent" 
                           placeholder="Ex: Tours de Nature et Aventure">
                    @error('meta_title')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                    <p class="text-gray-500 text-sm mt-1">Titre optimisé pour les moteurs de recherche (50-60 caractères)</p>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="meta_description" rows="3" 
                              class="w-full border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-purple-500 focus:border-transparent" 
                              placeholder="Description courte pour le référencement">{{ old('meta_description') }}</textarea>
                    @error('meta_description')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                    <p class="text-gray-500 text-sm mt-1">Description pour les résultats de recherche (150-160 caractères)</p>
                </div>
            </div>
