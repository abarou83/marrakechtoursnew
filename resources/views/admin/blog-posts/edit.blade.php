...
@section('content')
    ...
    <div class="bg-white rounded-xl shadow-lg p-8 max-w-4xl">
        <h2 class="text-2xl font-bold text-gray-900 mb-6"><i class="fas fa-edit mr-2"></i>Modifier l'article</h2>
                ...
                <div class="border border-gray-200 rounded-lg p-6">
                    ...
                    <div class="mt-4">
                        ...
                        @if($blogPost->featured_image)
                            <div class="mb-3">
                                <img src="{{ Storage::url($blogPost->featured_image) }}" alt="" class="w-48 h-32 object-cover rounded-lg border">
                    ...
                    <div class="flex items-center mt-4">
                        ...
                        <label for="is_active" class="ml-3 text-sm font-medium text-gray-700">Article publié</label>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        @foreach($availableLocales as $locale)
                            @php
                                ...
                                $translation = $blogPost->translations->where('locale', $locale)->first();
                            @endphp
