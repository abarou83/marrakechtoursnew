...
@section('title', 'Nouveau bloc de fonctionnalité')

@section('content')
<div class="max-w-3xl">
    <a href="{{ route('admin.feature-blocks.index') }}" class="text-indigo-600 hover:underline">← Retour</a>
    <h1 class="text-2xl font-bold mt-3 mb-6">Créer un bloc de fonctionnalité</h1>
    ...
    <form method="POST" action="{{ route('admin.feature-blocks.store') }}" enctype="multipart/form-data" class="bg-white rounded-xl shadow p-6 space-y-4">
        @csrf

        <div>
            <label class="block text-sm font-semibold text-gray-700 mb-1">Icône Font Awesome <span class="text-red-500">*</span></label>
            <input type="text" name="icon" id="icon-input" value="{{ old('icon', 'fa-solid fa-star') }}" class="w-full border-gray-300 rounded-lg px-4 py-3 mb-2" placeholder="fa-solid fa-phone" required>
            ...
            @php
                $allIcons = array_unique([
                            ...
                            'fa-eye', 'fa-eye-slash', 'fa-cog', 'fa-cogs', 'fa-sliders-h', 'fa-tools', 'fa-screwdriver',
                        ...
                        sort($allIcons);
                        $currentIcon = old('icon', 'fa-solid fa-star');
        ...
        <div class="border-t pt-4">
            ...
            <p class="text-xs text-gray-500 mb-2">Si vous uploadez une image, elle remplacera l'icône Font Awesome</p>
                ...
                @foreach($availableLocales as $locale)
                    ...
                    <div class="border-2 border-gray-200 rounded-lg p-4 hover:border-indigo-300 transition">
                        <div class="flex items-center mb-3">
                            ...
                            <h4 class="font-bold text-gray-900">{{ $localeInfo['native'] }}</h4>
        ...
        <div class="border-t pt-4" x-data="{ iconColorEnabled: false }">
                ...
                <div x-show="iconColorEnabled" x-transition class="space-y-3">
                    <div class="flex items-center gap-3">
                        <input type="color" 
                               ...
                               value="{{ old('icon_background_color', '#211951') }}" 
        ...
        <div class="grid grid-cols-2 gap-4 border-t pt-4">
            <div>
                ...
                <input type="number" name="order" value="{{ old('order', (App\Models\FeatureBlock::max('order') ?? 0) + 1) }}" min="0" class="w-full border-gray-300 rounded-lg">
                <p class="text-xs text-gray-500 mt-1">Définit l'ordre d'affichage</p>
            </div>
            <div class="flex items-center">
                <label class="inline-flex items-center mt-6">
                    <input type="checkbox" name="is_active" value="1" class="w-5 h-5 text-green-600 border-gray-300 rounded" checked>
